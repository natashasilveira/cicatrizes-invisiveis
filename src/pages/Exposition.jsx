...
import audio_breadcrumbing1 from '../assets/audio_breadcrumbing1.mp3'
import audio_breadcrumbing2 from '../assets/audio_breadcrumbing2.mp3'
import audio_gaslighting1 from '../assets/audio_gaslighting1.mp3'
import audio_gaslighting2 from '../assets/audio_gaslighting2.mp3'
import audio_ghosting1 from '../assets/audio_ghosting1.mp3'
import audio_ghosting2 from '../assets/audio_ghosting2.mp3'
import audio_hoovering1 from '../assets/audio_hoovering1.mp3'
import audio_hoovering2 from '../assets/audio_hoovering2.mp3'
import audio_love_bombing from '../assets/audio_love_bombing.mp3'
import audio_negging1 from '../assets/audio_negging1.mp3'
import audio_negging2 from '../assets/audio_negging2.mp3'
import audio_silent_treatment from '../assets/audio_silent_treatment.mp3'
        ...
        <Fade indicators={indicators} autoplay={false} className={styles.content} >
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={negging} />
              <div>
                <audio src={audio_negging1} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={negging2} />
              <div>
                <audio src={audio_negging2} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              ...
              <div>
                <audio src={audio_love_bombing} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              ...
              <div>
                <audio src={audio_breadcrumbing1} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              ...
              <div>
                <audio src={audio_silent_treatment} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={ghosting} />
              <div>
                <audio src={audio_ghosting1} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={ghosting2} />
              <div>
                <audio src={audio_ghosting2} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={hoovering} />
              <div>
                <audio src={audio_hoovering1} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
          ...
          <div className={styles.each_slide_effect}>
            <div className={styles.audio_slide}>
              <img src={hoovering2} />
              <div>
                <audio src={audio_hoovering2} controls controlsList='noplaybackrate nodownload' />
                <span className={styles.text_info}>
